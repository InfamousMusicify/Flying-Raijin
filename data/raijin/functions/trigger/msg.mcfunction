...
tellraw @s ["",{"text":"Save Tridents ","hoverEvent":{"action":"show_text","contents":["",{"text":"Default: 0\n0=ON - 1=OFF","color":"gray"}]},"color":"gray"},"",{"text":"(","color":"gray"},{"score":{"name":"#save_trident","objective":"raijin.config"},"color":"gray"},{"text":")","color":"gray"}]
tellraw @s ["",{"text":"Save Raijin Tridents ","hoverEvent":{"action":"show_text","contents":["",{"text":"Default: 0\n0=ON - 1=OFF","color":"gray"}]},"color":"gray"},"",{"text":"(","color":"gray"},{"score":{"name":"#save_raijin","objective":"raijin.config"},"color":"gray"},{"text":")","color":"gray"}]

tellraw @s ["",{"text":"Auto Recall ","hoverEvent":{"action":"show_text","contents":["",{"text":"Default: 0\n0=ON - 1=OFF","color":"gray"}]},"color":"gray"},"",{"text":"(","color":"gray"},{"score":{"name":"#auto_recall","objective":"raijin.config"},"color":"gray"},{"text":")","color":"gray"}]
...
# Fuses
tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger raijin set 2000000002"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Raijin Lockon\nClick to start to edit lockon time in seconds. \nAuto Recall Timer & Instant Auto Recall 'Off' Interval\n(How long each will trident be locked onto, \nset 60 or below, unless immortal raijin is on \nor tridents may be lost to despawning.","color":"gray"},{"text":"\nAccepts: whole numbers 0+\nDefault: 60\nMax: 2000000000\nServer: ","color":"dark_gray"},{"score":{"name":"#raijin_lock","objective":"raijin.config"},"color":"dark_gray"}]}}," Raijin Lockon ",{"text":"(","color":"gray"},{"score":{"name":"@s","objective":"raijin_arecall"},"color":"gray"},{"text":")","color":"gray"}]
