...
execute if score #config raijin.xpt matches 0 as @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag: {Tags: ["Raijin"]}}}] run function raijin:fr/lvl_2
execute if score #config raijin.xpt matches 0 as @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag: {Tags: ["Raijin"]}}]}] run function raijin:fr/lvl_2
# Recall
execute if score #config raijin.xpt matches 0 as @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag: {Tags: ["RaijinL1"]}}}] run function raijin:fr/lvl_1
execute if score #config raijin.xpt matches 0 as @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag: {Tags: ["RaijinL1"]}}]}] run function raijin:fr/lvl_1
