...
execute unless score #config raijin.cooldown matches 0.. run scoreboard players set #config raijin.cooldown 100
scoreboard objectives add raijin.cdtracker dummy
execute unless score #config raijin.cdtracker matches 0.. run scoreboard players set #config raijin.cdtracker 100
