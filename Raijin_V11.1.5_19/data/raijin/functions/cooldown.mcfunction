...
execute unless score #cdmsg2 raijin_id matches 1.. unless score @s raijin.cdtracker matches ..10 run tellraw @s[scores={raijin.cooldown=1},tag=!frcdmsg] ["",{"text":"Flying Raijin:","color":"gold"},{"text":" Ready","color":"yellow"}]
