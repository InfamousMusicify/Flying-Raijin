# 5 - Longer Lockon
scoreboard players set #preset raijin.config 5
##### ##### ##### ##### ##### ##### ##### ##### 

scoreboard players set #raijin_lock raijin.config 500
...
scoreboard players set #immortal_trident raijin.config 1
